...
- [ ] **Step 3: 实现 manifest 和归一化 comparator**
...
- [ ] **Step 3: 实现可归档、可恢复的 benchmark CLI**
...
- [ ] **Step 5: 记录既有 router regression 差异**
...
```bash
cd /Users/chang/Documents/AI_GENERATION
