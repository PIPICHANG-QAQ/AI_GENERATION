...
POSTPROCESS_ROOT = STORAGE_ROOT / "postprocess"
...
for directory in (UPLOAD_ROOT, OUTPUT_ROOT, JOB_ROOT, IMPORT_UPLOAD_ROOT, EXPORT_ROOT, BANK_IMAGE_ROOT, POSTPROCESS_ROOT):
