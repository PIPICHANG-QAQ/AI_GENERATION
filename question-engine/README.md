...
- 复核工作台：导入任务详情返回只读 `paperLayout`，试卷页图由 `/api/import-tasks/{jobId}/source/paper/pages/{pageIndex}` 提供，Python worker `PaperLayoutCapability` 负责布局解析框生成和页图渲染
...
- 代码结构与可迁移性评审：`docs/architecture/CODE_STRUCTURE_PORTABILITY_REVIEW.md`
