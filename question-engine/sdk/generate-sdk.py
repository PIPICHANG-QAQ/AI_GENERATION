...
EXPECTED_OPERATION_IDS = [
    ...
    "applyImportTaskCanonicalization",
    "rollbackImportTaskCanonicalization",
    "createStandardizationBatchJob",
    "getStandardizationBatchJob",
    "cancelStandardizationBatchJob",
    "resumeStandardizationBatchJob",
    "retryFailedStandardizationBatchItems",
